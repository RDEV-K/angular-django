...
SECRET_KEY = 'django-insecure-r+x#^=psw#^-xe!^^!@3rlv5fvy+=blt)vuu^fe(th%!)-58&c'
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:4200",  # Angular's default URL
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / 'production-static'  # Adjust this path as needed
STATICFILES_DIRS = [
    BASE_DIR / 'static'
    ]
